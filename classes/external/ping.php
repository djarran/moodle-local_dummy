...
namespace local_dummy\external;
...
class ping extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            'message' => new external_value(PARAM_TEXT, 'Message to echo back.', VALUE_DEFAULT, 'pong'),
        ]);
    }
     ...
     * @return array
     */
    public static function execute(string $message = 'pong'): array {
